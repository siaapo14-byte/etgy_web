...
export declare const MetaApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    apiMetaDictionariesGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20013>>>;
};
/**
...
export declare const MetaApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    apiMetaDictionariesGet(options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20013>>;
};
/**
