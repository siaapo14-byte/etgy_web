import { UID, RetryConfiguration, TurnServerConfigWithMode, CloudProxyServerMode, Candidate, Setup, FingerPrint, EventEmitter, PromiseMutex, SDKStore, SDK_CODEC, AgoraPCStats, NetworkQuality as NetworkQuality$1, AgoraVideoReceiverStats, WebSocketQuitReason, ConnectionDisconnectedReason } from '@agora-js/shared';
...
declare class P2PChannel extends EventEmitter {
    ...
    updateConnectionConfiguration(spec: PeerConnectionSpec): void;
